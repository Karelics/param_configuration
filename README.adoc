...
* What is the best git folder structure, when we have more layers than just model and device?
...
* Should there be changes to the git directory structure, if the parameters are deployed to multiple different computers on a single device?
